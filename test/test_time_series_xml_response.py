...
class TestTimeSeriesXmlResponse(unittest.TestCase):
    """TimeSeriesXmlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeSeriesXmlResponse:
        """Test TimeSeriesXmlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeSeriesXmlResponse`
        """
        model = TimeSeriesXmlResponse()
        if include_optional:
            return TimeSeriesXmlResponse(
                ip = '8.8.8.8',
    ...
    def testTimeSeriesXmlResponse(self):
        """Test TimeSeriesXmlResponse"""
