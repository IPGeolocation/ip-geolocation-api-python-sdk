...
class TestIPSecurityAPIResponse(unittest.TestCase):
    """IPSecurityAPIResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPSecurityAPIResponse:
        """Test IPSecurityAPIResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPSecurityAPIResponse`
        """
        model = IPSecurityAPIResponse()
        if include_optional:
            return IPSecurityAPIResponse(
                ip = '8.8.8.8',
    ...
    def testIPSecurityAPIResponse(self):
        """Test IPSecurityAPIResponse"""
