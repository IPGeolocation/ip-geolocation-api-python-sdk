...
class TestGetBulkIpGeolocationXmlResponse(unittest.TestCase):
    """GetBulkIpGeolocationXmlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBulkIpGeolocationXmlResponse:
        """Test GetBulkIpGeolocationXmlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBulkIpGeolocationXmlResponse`
        """
        model = GetBulkIpGeolocationXmlResponse()
        if include_optional:
            return GetBulkIpGeolocationXmlResponse(
                ip = '8.8.8.8',
                hostname = 'dns.google',
                domain = 'google.com',
...
United States', 
    ...
    def testGetBulkIpGeolocationXmlResponse(self):
        """Test GetBulkIpGeolocationXmlResponse"""
