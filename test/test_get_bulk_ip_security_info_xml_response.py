...
class TestGetBulkIpSecurityInfoXmlResponse(unittest.TestCase):
    """GetBulkIpSecurityInfoXmlResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBulkIpSecurityInfoXmlResponse:
        """Test GetBulkIpSecurityInfoXmlResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBulkIpSecurityInfoXmlResponse`
        """
        model = GetBulkIpSecurityInfoXmlResponse()
        if include_optional:
            return GetBulkIpSecurityInfoXmlResponse(
                ip = '8.8.8.8',
    ...
    def testGetBulkIpSecurityInfoXmlResponse(self):
        """Test GetBulkIpSecurityInfoXmlResponse"""
