...
class TestIPSecurityAPIXMLResponseArray(unittest.TestCase):
    """IPSecurityAPIXMLResponseArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPSecurityAPIXMLResponseArray:
        """Test IPSecurityAPIXMLResponseArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPSecurityAPIXMLResponseArray`
        """
        model = IPSecurityAPIXMLResponseArray()
        if include_optional:
            return IPSecurityAPIXMLResponseArray(
                ip = '8.8.8.8',
    ...
    def testIPSecurityAPIXMLResponseArray(self):
        """Test IPSecurityAPIXMLResponseArray"""
