...
class TestAstronomyXMLResponse(unittest.TestCase):
    """AstronomyXMLResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AstronomyXMLResponse:
        """Test AstronomyXMLResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AstronomyXMLResponse`
        """
        model = AstronomyXMLResponse()
        if include_optional:
            return AstronomyXMLResponse(
                ip = '8.8.8.8',
                location = ipgeolocation.models.timezone_location.TimezoneLocation(
                    ...
                    latitude = '-27.47306', 
                    longitude = '153.01421', ),
                astronomy = ipgeolocation.models.astronomy.Astronomy(
    ...
    def testAstronomyXMLResponse(self):
        """Test AstronomyXMLResponse"""
