...
class TestGeolocationResponse(unittest.TestCase):
    """GeolocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeolocationResponse:
        """Test GeolocationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeolocationResponse`
        """
...
United States', 
    ...
    def testGeolocationResponse(self):
        """Test GeolocationResponse"""
