...
class TestGetBulkIpGeolocationResponse(unittest.TestCase):
    """GetBulkIpGeolocationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBulkIpGeolocationResponse:
        """Test GetBulkIpGeolocationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBulkIpGeolocationResponse`
        """
        model = GetBulkIpGeolocationResponse()
        if include_optional:
            return GetBulkIpGeolocationResponse(
...
United States''',
    ...
    def testGetBulkIpGeolocationResponse(self):
        """Test GetBulkIpGeolocationResponse"""
