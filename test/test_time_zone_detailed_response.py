...
class TestTimeZoneDetailedResponse(unittest.TestCase):
    """TimeZoneDetailedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeZoneDetailedResponse:
        """Test TimeZoneDetailedResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeZoneDetailedResponse`
        """
        model = TimeZoneDetailedResponse()
        if include_optional:
    ...
    def testTimeZoneDetailedResponse(self):
        """Test TimeZoneDetailedResponse"""
