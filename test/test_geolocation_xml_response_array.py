...
class TestGeolocationXMLResponseArray(unittest.TestCase):
    """GeolocationXMLResponseArray unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GeolocationXMLResponseArray:
        """Test GeolocationXMLResponseArray
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeolocationXMLResponseArray`
        """
        model = GeolocationXMLResponseArray()
        if include_optional:
            return GeolocationXMLResponseArray(
                ip = '8.8.8.8',
                hostname = 'dns.google',
                domain = 'google.com',
...
United States', 
    ...
    def testGeolocationXMLResponseArray(self):
        """Test GeolocationXMLResponseArray"""
