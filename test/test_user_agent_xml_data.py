...
class TestUserAgentXMLData(unittest.TestCase):
    """UserAgentXMLData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserAgentXMLData:
        """Test UserAgentXMLData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UserAgentXMLData`
        """
        model = UserAgentXMLData()
        if include_optional:
            return UserAgentXMLData(
                user_agent_string = '',
                name = '',
                type = '',
                version = '',
