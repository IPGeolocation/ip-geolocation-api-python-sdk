...
class TestAstronomyResponse(unittest.TestCase):
    """AstronomyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AstronomyResponse:
        """Test AstronomyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AstronomyResponse`
        """
    ...
    def testAstronomyResponse(self):
        """Test AstronomyResponse"""
