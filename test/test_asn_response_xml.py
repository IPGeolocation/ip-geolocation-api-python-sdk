...
class TestASNResponseXML(unittest.TestCase):
    """ASNResponseXML unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ASNResponseXML:
        """Test ASNResponseXML
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ASNResponseXML`
        """
        model = ASNResponseXML()
        if include_optional:
            return ASNResponseXML(
                ip = '81.73.154.79',
                asn = ipgeolocation.models.asn_details.ASNDetails(
                    as_number = 'AS3269', 
