...
class TestGetBulkIpSecurityInfoResponse(unittest.TestCase):
    """GetBulkIpSecurityInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBulkIpSecurityInfoResponse:
        """Test GetBulkIpSecurityInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBulkIpSecurityInfoResponse`
        """
        model = GetBulkIpSecurityInfoResponse()
        if include_optional:
            return GetBulkIpSecurityInfoResponse(
                ip = '8.8.8.8',
    ...
    def testGetBulkIpSecurityInfoResponse(self):
        """Test GetBulkIpSecurityInfoResponse"""
