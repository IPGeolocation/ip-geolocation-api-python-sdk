"""Primary IPGeolocation API client."""
...
from ._transport import HttpRequestData, HttpTransport, RequestsHttpTransport
...
class IpGeolocationClient:
    """Primary client for the IPGeolocation API."""
    ...
    def __init__(
        ...
        self._transport = transport if transport is not None else RequestsHttpTransport()
        self._closed = False
    ...
    def lookup_ip_geolocation(
        ...
        response, duration_ms = self._execute_with_metrics(http_request)
    ...
    def bulk_lookup_ip_geolocation(
        self,
    ...
    def bulk_lookup_ip_geolocation_raw(
        self,
        request: Optional[BulkLookupIpGeolocationRequest],
    ) -> ApiResponse[str]:
    ...
    def __enter__(self) -> "IpGeolocationClient":
        self._ensure_open()
        return self
    ...
    def _execute_with_metrics(self, request: HttpRequestData):
