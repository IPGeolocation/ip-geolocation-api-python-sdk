...
class TimezoneLocation(BaseModel):
    """
    TimezoneLocation
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["location_string", "continent_code", "continent_name", "country_code2", "country_code3", "country_name", "country_name_official", "is_eu", "state_prov", "state_code", "district", "city", "locality", "zipcode", "latitude", "longitude"]
