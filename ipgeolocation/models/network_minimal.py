...
class NetworkMinimal(BaseModel):
    """
    NetworkMinimal
    """ # noqa: E501
    asn: Optional[NetworkMinimalAsn] = None
    company: Optional[NetworkMinimalCompany] = None
    __properties: ClassVar[List[str]] = ["asn", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asn": NetworkMinimalAsn.from_dict(obj["asn"]) if obj.get("asn") is not None else None,
            "company": NetworkMinimalCompany.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
