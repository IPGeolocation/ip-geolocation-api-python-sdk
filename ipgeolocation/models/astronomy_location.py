...
class AstronomyLocation(BaseModel):
    """
    AstronomyLocation
    """ # noqa: E501
    location_string: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["location_string", "continent_code", "continent_name", "country_code2", "country_code3", "country_name", "country_name_official", "is_eu", "state_prov", "state_code", "district", "city", "locality", "zipcode", "latitude", "longitude", "elevation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location_string": obj.get("location_string"),
