...
class Network(BaseModel):
    ...
    Network
    """ # noqa: E501
    asn: Optional[NetworkAsn] = None
    connection_type: Optional[StrictStr] = None
    company: Optional[NetworkCompany] = None
    __properties: ClassVar[List[str]] = ["asn", "connection_type", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "asn": NetworkAsn.from_dict(obj["asn"]) if obj.get("asn") is not None else None,
            "connection_type": obj.get("connection_type"),
            "company": NetworkCompany.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
