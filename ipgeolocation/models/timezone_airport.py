...
class TimezoneAirport(BaseModel):
    """
    TimezoneAirport
    """ # noqa: E501
    ...
    elevation_ft: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "name", "latitude", "longitude", "elevation_ft", "continent_code", "country_code", "state_code", "city", "iata_code", "icao_code", "faa_code"]
