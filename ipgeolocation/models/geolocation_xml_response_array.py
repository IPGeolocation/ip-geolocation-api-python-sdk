...
class GeolocationXMLResponseArray(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ip", "hostname", "domain", "location", "country_metadata", "network", "currency", "security", "abuse", "time_zone", "user_agent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GeolocationXMLResponseArray from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of abuse
        if self.abuse:
            _dict['abuse'] = self.abuse.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GeolocationXMLResponseArray from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "abuse": Abuse.from_dict(obj["abuse"]) if obj.get("abuse") is not None else None,
