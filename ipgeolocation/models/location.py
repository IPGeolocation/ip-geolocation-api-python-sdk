...
class Location(BaseModel):
    ...
    accuracy_radius: Optional[StrictStr] = None
    locality: Optional[StrictStr] = None
    dma_code: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["continent_code", "continent_name", "country_code2", "country_code3", "country_name", "country_name_official", "country_capital", "state_prov", "state_code", "district", "city", "zipcode", "latitude", "longitude", "is_eu", "country_flag", "geoname_id", "country_emoji", "accuracy_radius", "locality", "dma_code"]
