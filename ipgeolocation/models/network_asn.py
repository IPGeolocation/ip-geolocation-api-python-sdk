...
class NetworkAsn(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["as_number", "organization", "country", "asn_name", "type", "domain", "date_allocated", "allocation_status", "num_of_ipv4_routes", "num_of_ipv6_routes", "rir"]
